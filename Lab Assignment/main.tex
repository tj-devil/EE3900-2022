...
\title{Linear Systems & Signal Processing\\Lab Assignment\\5V Charger\\ Using a Low Pass Filter}
...
\bigskip
\begin{abstract}
    The following is a report on the realization of a 5 V charger using
