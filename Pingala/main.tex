...
\begin{document}
	...
	%
	\author{ Tejash Agrahari \\ EP20BTECH11024 %<-this  stops a space
...
\begin{lstlisting}
$ wget https://github.com/tj-devil/EE3900-2022/blob/main/Pingala/codes/Ex_1.py
\end{lstlisting}
\end{enumerate}
...
\begin{lstlisting}
$ wget https://github.com/tj-devil/EE3900-2022/blob/main/Pingala/codes/Ex_2.2.py
\end{lstlisting}
\begin{figure}[!ht]
	\centering
...
\begin{lstlisting}
$ wget https://github.com/tj-devil/EE3900-2022/blob/main/Pingala/codes/Ex_2.5.py
\end{lstlisting}
\begin{figure}[!ht]
	\centering
